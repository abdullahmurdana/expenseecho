        ...
        children: [
          Align(
            ...
            child: Obx(() {
              ...
              double bottomSheetHeight = size.height * 0.60;
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                          ...
                          child: DropdownButtonFormField<CategoryModel>(
                            ...
                            items: expenseAddNewController.categories
                              ...
                              return DropdownMenuItem<CategoryModel>(
                                ...
                                child: Text(
                                  category.name,
                                  style: AppStyle.poppinsRegularBlack(
                                      fontSize: 16),
                                ),
                              );
                            }).toList(),
                      ...
                      Obx(() => buildTextField(
                            controller:
                                expenseAddNewController.titleController.value,
                      ...
                      Padding(
                        ...
                        //  Obx(() {
                        //   final controller =
                        //       Get.find<ExpenseAddNewController>();
                        ...
                        //       // }
                        //       await controller.createExpense().then((value) {
                        //         if (value) {
                        //           showSuccessDialog(
