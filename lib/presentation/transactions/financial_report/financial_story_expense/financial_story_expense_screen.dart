...
class FinancialStoryExpenseScreen extends StatefulWidget {
  const FinancialStoryExpenseScreen({super.key});

  @override
  _FinancialStoryExpenseScreenState createState() =>
      _FinancialStoryExpenseScreenState();
}

class _FinancialStoryExpenseScreenState
    extends State<FinancialStoryExpenseScreen> {
  final controller = Get.find<FinancialStoryExpenseController>();
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  Text(
                    localization.msg_you_spend,
                    style: AppStyle.poppinsBoldWhite(fontSize: 40),
                  ),
                  15.h,
                  Obx(() {
                    return Text(
                      '\$${controller.totalExpenseForCurrentMonth.value.toStringAsFixed(2)}',
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Text(
                        localization.msg_biggest_spending,
                        style: AppStyle.poppinsMediumBlack(fontSize: 24),
                      ),
                      16.h,
                      Obx(() {
                        if (controller.highestExpense.value != null) {
                          var highestExpense = controller.highestExpense.value!;
                          return Column(
                            children: [
                              Container(
                              ...
                              16.h,
                              Text(
                                '\$${highestExpense.expenseAmount.toStringAsFixed(2)}',
                                style:
